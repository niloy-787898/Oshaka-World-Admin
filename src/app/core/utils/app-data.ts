...
export const ORDER_STATUS: Select[] = [
  ...
  { value: OrderStatus.ReadToPrint, viewValue: 'Ready To Print'},
  { value: OrderStatus.PrintInvoice, viewValue: 'Print Invoice'},
  { value: OrderStatus.ReadyToPackaging, viewValue: 'Ready to packaging '},
  { value: OrderStatus.Packaging, viewValue: 'packaging '},
  { value: OrderStatus.ReadyToShipped, viewValue: 'Ready To Shipped'},
  { value: OrderStatus.HoldInvoice, viewValue: 'Hold Invoice'},
];
