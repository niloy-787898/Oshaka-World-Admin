...
import { ConfirmDialogWithCheckComponent } from '../../../../../shared/components/ui/confirm-dialog-with-check/confirm-dialog-with-check.component';
...
export class AllPromoOfferComponent
  implements OnInit, AfterViewInit, OnDestroy
{
      ...
      .pipe(
        ...
        switchMap((data) => {
          ...
          if (this.searchQuery === '' || this.searchQuery === null) {
            ...
            console.log('totalPromoOffers', this.totalPromoOffers);
  ...
  private getAllPromoOffers() {
    ...
    this.subDataOne = this.promoOfferService
      .getAllPromoOffers(filterData, this.searchQuery)
      .subscribe(
        (res) => {
          this.spinner.hide();
  ...
  private deletePromoOfferById(id: string) {
    this.spinner.show();
    this.subDataFive = this.promoOfferService
      .deletePromoOfferById(id, false)
      .subscribe(
        (res) => {
          this.spinner.hide();
          if (res.success) {
  ...
  private deleteMultiplePromoOfferById(checkUsage: boolean) {
    this.spinner.show();
    this.subDataFour = this.promoOfferService
      .deleteMultiplePromoOfferById(this.selectedIds, checkUsage)
      .subscribe(
        (res) => {
          this.spinner.hide();
          if (res.success) {
  ...
  private updateMultiplePromoOfferById(data: any) {
    this.spinner.show();
    this.subDataThree = this.promoOfferService
      .updateMultiplePromoOfferById(this.selectedIds, data)
      .subscribe(
        (res) => {
          this.spinner.hide();
          if (res.success) {
