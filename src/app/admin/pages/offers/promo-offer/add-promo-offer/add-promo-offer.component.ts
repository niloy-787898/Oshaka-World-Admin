    ...
    const mData = {
      ...
      ...{
        ...
        products: this.selectedProducts.map(m => {
          return {
            product: {...m,  discountType:m.offerDiscountType ? Number(m.offerDiscountType) : null,
              discountAmount:m.offerDiscountAmount ? Number(m.offerDiscountAmount) : null, slug2:this.dataForm.value.slug},
